...
<div>
<h3 style="font-size:18px;text-align:center;background:gray;color:#fff;padding:10px;margin:0">Update Profile</h3>							
				<?php
		...
		<form action="" method="post" enctype="multipart/form-data">
			...
			<tr>
				...
				<td>
				    <img id="logo_preview" src="img/student/<?php echo $row['img']?>" style="height:150px; width:150px; border:1px gray solid;"><br><br> 
			...
			<table>
				...
				<tr>
					<td colspan="2">
						<input style="background:gray;color:#fff;width:168px;border-radius:5px;" type="submit" name="Update" value="Update">
					</td>						
				</tr>
			</table>
			<?php } ?>
	...
	<div>
		<p style="text-align:center"><a href="admin_all_student.php"><button class="editbtn">Back to your Profile</button></a></p>
	</div>
</div>
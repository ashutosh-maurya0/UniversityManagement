...
<div>
	<?php
		...
		function credit_hour($x){
			...
			elseif($x == "DSA") return 3;
			elseif($x == "DSA Lab") return 1;
			elseif($x == "English") return 4;
			elseif($x == "Physics") return 3;
			elseif($x == "Chemistry") return 3;
			elseif($x == "Holistic Education") return 3;
			elseif($x == "Digital System") return 3;
			elseif($x == "Software Engnineering") return 3;
		}
	...
	<!--Infomation of student-->
		...
		<tr>
			...
			<td>
				<?php echo credit_hour($rows['sub']); ?></td>
			<td>
			<?php
					$stat = $rows['marks'];
					if($stat<60){
		...
		?>
		<p style="float:right;text-align:left;margin:20px 0;width:53.5%"><a href="st_profile.php"><button class="editbtn">Back to profile</button></a></p>
</div>

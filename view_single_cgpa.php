...
<div  class="fix">	
	<p style='text-align:center;background:#ddd;color:gray;padding:5px;width:84%;margin:0 auto'>All Completed Course & Grade</p>
</div>
	<?php
	//select semester
			$i=0;
		...
		?>
			...
			<td><?php echo "Total Course: <span style='color:black;padding:3px 6px;font-size:18px'>".$i."</span>"; ?></td>
				...
				<?php
				$sg = $gp/$ch;
				echo "<span style='color:black;padding:3px 6px;font-size:18px'>" . round($sg,2) . "</span>"; ?>
				</td>
				<td>
					<?php
						if($sg>=3.5){

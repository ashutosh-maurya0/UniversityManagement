...
<div class="all_student fix">
	...
	<p style='text-align:center;background:#ddd;color:Black;padding:5px;width:84%;margin:0 auto'>All Completed Course & Grade</p>
	<?php
	//select semester
		$i=0;
		$ch = 0;
	...
	<?php		
		...
		?>
			...
			<?php } ?>
			<tr>
			<td><?php echo "Total Course: <span style='color:black;padding:3px 6px;font-size:18px'>".$i."</span>"; ?></td>
				<td colspan="1">Total CGPA : </td>
				<td colspan="2">
				<?php
				$sg = $gp/$ch;
				echo "<span style='color:balck;padding:3px 6px;font-size:18px'>" . round($sg,2) . "</span>"; ?>
				</td>
				<td>
					<?php
						if($sg>=3.5){

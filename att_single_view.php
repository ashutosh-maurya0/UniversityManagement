...
<div>
	...
	<div style="background:#ddd;padding:20px;">
		<span style="float:left;"><a style="color:#fff;" href="class_att.php"><button style="background:gray;border:none;color:#fff;padding:10px;">Take Attendance</button></a></span>

...
<div>
	...
	<div>
	<p style="float:left;margin:0 0 5px 0;margin-top:1%;width:100%;text-align:center;"><a href="view_cgpa.php?vr=<?php echo $stid; ?>&vn=<?php echo $name; ?>"><button class="editbtn">View cgpa & completed course</button></a></p>
	</div>
	<div style="margin-left:29;margin-top:3%;">
	<form action="" method="post" style="width:23%;margin-top:1%;padding-bottom:5px;">
		<select name="seme" id="">
	...
	?>
	<p>
		<?php echo "<p style='text-align:center;background:#ddd;color:#01C3AA;padding:5px;width:84%;margin:0 auto'>".$semester." Semester Result"?></p>
		<table class="center" style="text-align:center;width:85%;margin:0 auto">
			<th>Subject</th>
			<th>Marks</th>
			<th>Grade</th>
			<th>Credit hr.</th>
		...
		?>
		<p style="float:left; text-align:right;margin:20px 0;width:53%"><a href="st_result_update.php?ar=<?php echo $stid?>&seme=<?php echo $semester?>&vn=<?php echo $name?>"><button class="editbtn">Edit Result</button></a></p>
		<?php 
				}
		?>
		<p style="float:right;text-align:left;margin:20px 0;width:52.5%"><a href="st_result.php"><button class="editbtn">Back to list</button></a></p>
</div>
...
<div>
	...
	<div  style="background:#ddd;padding:20px;">
		<span style="float:left;"><a style="color:#fff;" href="att_add.php"><button style="background:gray;border:none;color:#fff;padding:10px;">Add student</button></a></span>
		<span style="float:right;"><a style="color:#fff;" href="att_view.php"> <button style="background:gray;border:none;color:#fff;padding:10px;">View Attendance</button></a></span>
	</div>
	<?php
	...
	<?php
		if($_SERVER['REQUEST_METHOD'] == 'POST'){
			...
			if($res){
				echo "<h3 style='color:gray;margin:0;padding:0;text-align:center'>Attendance data successfully inserted!</h3>";
			}else{
	...
	?>
		...
		<form action="" method="post">
			<p style="text-align:center;color:red;">
				<mark>Select dat: <input type="date" name="attndate" required/></mark>
			</p>
			...
			<span><input style="<text-align:right></text-align:right>;background:gray;border:none;color:#fff;padding:8px 100px;" type="submit" name="submit" value="Submit" /></span>
		</form>
	<div>
</div>
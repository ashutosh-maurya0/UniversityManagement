...
?>
	<div class="st_reg fix">
		<h2 style="color:#ddd;background:gray">Faculty Retistration</h2>
		<p class="msg">
				<?php
		...
		<form action="" method="post" id="st_form">
			<table>
				...
				<tr>
					<th>Username: </th>
					<td><input type="text" maxlength="3" name="uname" placeholder="username" required /></td>
				</tr>
				<tr>
					<th>Password: </th>
					...
					<td>
						<fieldset>
						  	<select class="select-style" name="degree">
								...
								<option value="Phd" >M.Tech</option>
								<option value="Phd" >B.Arch</option>
								<option value="Phd" >BBA</option>
				...
				<tr>
					<th>Contact:</th>
					<td><input type="text" maxlength="10" name="st_contact" placeholder="phone" required /></td>
				</tr>
				<tr>
					<th>Address:</th>
				...
				<tr>
					<td colspan="2"><input style="color:#ddd;background:gray" type="submit" name="sub" value="Register" /></td>
				</tr>
			</table>
		</form>
	</div>
